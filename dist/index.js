...
program
    .name('glskills')
    .description(`${chalk.cyan('glskills')} — Install GenLayer skills for AI coding assistants\n` +
...
program
    ...
    .option('--ai <type>', `AI assistant to install for (${AI_TYPES.filter(t => t !== 'all').join(', ')}, all)`)
